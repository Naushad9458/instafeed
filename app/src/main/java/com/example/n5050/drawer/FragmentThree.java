...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearLayout=(LinearLayout) view.findViewById(R.id.frame3);
        ...
        teacher.setText("Taught By: "+sharedPreferences.getString("teacher2",""));
                ...
                StringRequest request=new StringRequest(Request.Method.POST, submiturl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equalsIgnoreCase("Success")){
                            ...
                            edit.putString("course3_res","true");
                            edit.commit();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("course",sharedPreferences.getString("course2","0"));
