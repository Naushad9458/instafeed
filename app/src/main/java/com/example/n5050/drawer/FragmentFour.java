...
public class FragmentFour extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearLayout=(LinearLayout) view.findViewById(R.id.frame4);
        ...
        teacher.setText("Taught By: "+sharedPreferences.getString("teacher3",""));
                ...
                StringRequest request=new StringRequest(Request.Method.POST, submiturl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equalsIgnoreCase("Success")){
                            ...
                            edit.putString("course4_res","true");
                            edit.commit();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("course",sharedPreferences.getString("course3","0"));
