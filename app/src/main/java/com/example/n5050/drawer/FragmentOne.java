...
public class FragmentOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearLayout=(LinearLayout) view.findViewById(R.id.frame1);
        ...
        teacher.setText("Taught By: "+sharedPreferences.getString("teacher0",""));
                ...
                StringRequest request=new StringRequest(Request.Method.POST, submiturl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equalsIgnoreCase("Success")){
                            ...
                            edit.putString("course1_res","true");
                            edit.commit();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("course",sharedPreferences.getString("course0","0"));
